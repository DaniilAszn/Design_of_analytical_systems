...
param3 = st.number_input("Введите значение максимальной скорости (в км/ч)", min_value=90.0, max_value=290.0)
param3 = (param3 - 209) / 45
...
if st.button("Получить ответ"):
    input_features = pd.DataFrame({
        ...
        'Максимальная скорость [км/ч]': [param3]
    })
